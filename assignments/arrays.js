...
//3 options to do the same thing
for(let i = 0; i < inventory.length; i++) {
  if (inventory[i].id === 33){
  console.log(inventory[i])
  }
}
const item = inventory[32];
...
console.log(`The Car make is: ${lastCar.car_make}, Car model is: ${lastCar.car_model}`);
...
//if you want the car details for all the cars older the year 2000
for(let i = 0; i < inventory.length; i++) {
