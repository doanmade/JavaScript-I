...
let lastCar = 0;
inventory.reverse()
const lastItem = inventory[lastCar];


console.log(`last cast is id ${lastItem.id} ${lastItem.car_make} ${lastItem.car_model} ${lastItem.car_year}`);
